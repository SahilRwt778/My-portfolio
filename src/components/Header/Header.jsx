    ...
    return (
        <>
            <animated.div style={slideInStyles} ref={ref}>
                ...
                >
                    <div className="mx-4 md:mx-12 lg:mx-[6rem] relative overflow-hidden">
                        <div className="mt-5 flex flex-wrap items-center p-8 bg-blue-70 m-0 relative z-10">
                            <div className="w-full lg:w-1/2 flex flex-col items-start text-left mb-4 md:mb-0">
                                ...
                                <div className="flex flex-wrap mt-10">
                                    ...
                                    <div className="best-skills ml-0 md:ml-8 max-[768px]:text-center max-[768px]:my-8">
                                        ...
                                        <div className="flex">
                                            <FaReact className="text-white text-[30px] md:text-[40px] lg:text-[50px] bg-black rounded-lg p-2 mx-2 md:mx-4 shadow-lg" />
